...
exercises:
  ...
  - id: 4e-rel-t3
    ...
    solution: There are three negative factors ($-2$, $-4$, $-1$), so the number of negative factors is odd, which makes the product negative. Calculation gives $(-2)\times 3 = -6$, $(-6)\times(-4)=24$, $24\times(-1)=-24$, $(-24)\times 5=-120$. The product is $-120$, confirming it is negative.
    hints:
  ...
  - id: 4e-rel-t4
    ...
    solution: >-
      $a\times b>0$ means $a$ and $b$ have the same sign. $b\times c<0$ means $b$ and $c$ have different signs. $a\times c<0$ means $a$ and $c$ have different signs. If $a>0$ then $b>0$ and $c<0$. If $a<0$ then $b<0$ and $c>0$. There are exactly two valid sign assignments: $(+,+,-)$ and $(-,-,+)$.
    hints:
...
- **Odd** number of negative factors gives a negative product.
