...
exercises:
  ...
  - id: 4e-transvec-t2
    ...
    solution: $A'=(4,-1)$, $B'=(7,-1)$, $C'=(4,3)$. The length $A'B'=\sqrt{(7-4)^2+(-1-(-1))^2}=\sqrt{9}=3$, which equals $AB$.
    hints:
  ...
  - id: 4e-transvec-t3
    ...
    solution: The translation vector is $\vec{u}=\vec{AA'}=(2-0,3-0)=(2,3)$. Then $B'=(5,5)$ and $C'=(3,7)$. We check $\vec{AB}=(3,2)$ and $\vec{A'B'}=(5-2,5-3)=(3,2)$. They are equal.
    hints:
  ...
  - id: 4e-transvec-t4
    ...
    solution: >-
      Let $P=(x,y)$. After the first translation, $P_1=(x+a,y+b)$. After the second, $P_2=(x+a+c,y+b+d)$. This is a translation by $(a+c,b+d)$. For the second part, the image of $(0,0)$ after $\vec{u}$ is $(a,b)$ on $y=x$, so $b=a$. With $a+c=5$ and $a+d=1$, one solution is $a=2$, giving $\vec{u}=(2,2)$ and $\vec{v}=(3,-1)$.
    hints:
