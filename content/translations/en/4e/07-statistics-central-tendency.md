...
exercises:
  ...
  - id: 4e-stat-t3
    ...
    solution: >-
      Ordered data: $13, 13, 14, 14, 14, 15, 15, 16, 16, 42$. Mean $= 172 \div 10 = 17.2$. Median $= (14+15) \div 2 = 14.5$. Range $= 42 - 13 = 29$. The median ($14.5$) better represents the typical age because the mean ($17.2$) is pulled upward by the outlier $42$.
    hints:
  ...
  - id: 4e-stat-t4
    ...
    solution: >-
      The sum is $35$. The median is the third value, so $a < b < 6 < d < e$ with $e - a = 10$. Then $a + b + d + e = 29$ and $e = a + 10$, giving $2a + b + d = 19$. Testing systematically: $\{1,7,6,10,11\}$, $\{1,8,6,9,11\}$, $\{2,4,6,11,12\}$, $\{2,5,6,10,12\}$, $\{3,4,6,9,13\}$, $\{3,5,6,8,13\}$.
    hints:
