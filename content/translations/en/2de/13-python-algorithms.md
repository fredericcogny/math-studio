...
exercises:
  ...
  - id: 2de-python-t3
    ...
    solution: "A possible function accumulates a sum and a count.\n```\ndef mean_of_large(values):\n    total = 0\n    count = 0\n    for v in values:\n        if v > 10:\n            total = total + v\n            count = count + 1\n    if count == 0:\n        return 0\n    return total / count\n```\nThe guard on count is what prevents a division by zero on a list with no value above $10$. On the list [4, 12, 20, 7, 16], the values kept are $12$, $20$ and $16$, so total is $48$ and count is $3$. The function returns $48/3=16$."
    hints:
