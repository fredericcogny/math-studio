...
exercises:
  ...
  - id: 5e-signed-t2
    ...
    hints:
      - Work backward from the final temperature or represent the unknown fall by $d$.
...
Do not memorize an isolated “two minuses make a plus” slogan. Rewrite the operation:
