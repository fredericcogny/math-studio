...
flashcards:
  ...
  - front: Which is evaluated first in $7+3^2\times2$?
    back: >-
      The power: $3^2=9$, then the multiplication, then the addition.
...
exercises:
  ...
  - id: 5e-powers-t2
    ...
    solution: >-
      Powers come first: $2^3=8$ and $4^2=16$. Then multiply: $3+8\times5-16=3+40-16=27$.
    hints:
  ...
  - id: 5e-powers-t3
    ...
    solution: >-
      Substitute first: $2\times4^2+3^3-(4-3)^2$. Evaluate the parentheses and powers: $2\times16+27-1$. Then perform the multiplication before the addition and subtraction: $32+27-1=58$.
    hints:
