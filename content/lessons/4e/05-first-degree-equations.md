...
tieredExercises:
  ...
  - id: "4e-feq-t3"
    ...
    solution: "Let $w$ be the width. The length is $2w + 3$. The perimeter gives $2(w + 2w + 3) = 54$, so $2(3w + 3) = 54$, hence $6w + 6 = 54$, $6w = 48$, $w = 8$. The width is $8$ cm and the length is $2(8) + 3 = 19$ cm. Check: $2(8 + 19) = 2 \\times 27 = 54$ cm."
    hints:
  ...
  - id: "4e-feq-t4"
    ...
    solution: "Write $3n + 7 = 3(n - 1) + 10$, so $\\frac{3n+7}{n-1} = 3 + \\frac{10}{n-1}$. This is an integer when $n - 1$ divides $10$. The divisors of $10$ are $\\pm 1, \\pm 2, \\pm 5, \\pm 10$, giving $n - 1 \\in \\{-10,-5,-2,-1,1,2,5,10\\}$, so $n \\in \\{-9,-4,-1,0,2,3,6,11\\}$."
    hints:
