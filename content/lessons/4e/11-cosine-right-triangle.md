...
tieredExercises:
  - id: "4e-cosrt-t1"
    ...
    solution: "$\\cos(60°)=\\frac{\\text{adjacent}}{\\text{hypotenuse}}=\\frac{\\text{adjacent}}{10}=0.5$, so the adjacent side $=10\\times 0.5=5$."
    hints:
  ...
  - id: "4e-cosrt-t2"
    ...
    solution: "The distance from the wall is the side adjacent to the $35°$ angle: $d=6\\times\\cos(35°)\\approx 6\\times 0.819=4.914$ m, which rounds to $4.9$ m. By Pythagoras, the height is $h=\\sqrt{6^2-4.914^2}=\\sqrt{36-24.15}=\\sqrt{11.85}\\approx 3.4$ m."
    hints:
  ...
  - id: "4e-cosrt-t3"
    ...
    solution: "$\\cos(\\widehat{ABC})=\\frac{BC}{AB}=\\frac{5}{13}\\approx 0.3846$. So $\\widehat{ABC}=\\cos^{-1}(0.3846)\\approx 67.4°$. By Pythagoras, $AC=\\sqrt{13^2-5^2}=\\sqrt{169-25}=\\sqrt{144}=12$. Check: $\\cos(\\widehat{BAC})=\\frac{AC}{AB}=\\frac{12}{13}\\approx 0.923$, giving $\\widehat{BAC}\\approx 22.6°$. And $67.4°+22.6°=90°$, confirming the result."
    hints:
  ...
  - id: "4e-cosrt-t4"
    ...
    solution: "Since $ABC$ is isosceles with $AB=AC$, the perpendicular $AH$ bisects $BC$, so $\\widehat{BAH}=30°$. In right triangle $ABH$: $\\cos(30°)=\\frac{BH}{AB}$, but actually $\\cos(\\widehat{ABH})$ is more direct. Since $\\widehat{A}=60°$ and the triangle is isosceles, $\\widehat{B}=\\widehat{C}=60°$, so the triangle is equilateral. Then $BH=\\frac{BC}{2}=\\frac{10}{2}=5$. The height $AH=\\sqrt{10^2-5^2}=\\sqrt{75}=5\\sqrt{3}$. The area is $\\frac{1}{2}\\times 10\\times 5\\sqrt{3}=25\\sqrt{3}$."
    hints:
