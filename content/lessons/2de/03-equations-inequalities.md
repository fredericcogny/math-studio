...
tieredExercises:
  ...
  - id: '2de-eqineq-t4'
    ...
    solution: 'The value $x=2$ is forbidden. On the rest of the line, subtract $1$ from both sides and put everything over one denominator: $\dfrac{x+1}{x-2}-1=\dfrac{(x+1)-(x-2)}{x-2}=\dfrac{3}{x-2}$. The inequality becomes $\dfrac{3}{x-2}\geqslant 0$. Since the numerator $3$ is positive, the quotient is nonnegative exactly when $x-2>0$, and it is never zero. The solution set is therefore $]2,\;+\infty[$. Multiplying both sides by $x-2$ is invalid because the sign of $x-2$ depends on $x$: for $x<2$ the multiplication reverses the inequality, so a single multiplication cannot treat both sides of $2$ at once. Checking $x=0$ confirms this, since $\dfrac{0+1}{0-2}=-0.5$, which is not greater than or equal to $1$.'
    hints:
